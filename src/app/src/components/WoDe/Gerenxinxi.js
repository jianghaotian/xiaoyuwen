...
export default class Gerenxinxi extends Component {
    ...
    render() {
        return (
            <div>
                <NavBar mode="dark" icon={<Icon type="left" onClick={()=>{this.toPath('/home/wode')}}/>} style={{background:'#617ca6',color:'#fff'}}>个 人 信 息</NavBar>
                ...
                <div className="grxx_box a_click" onClick={()=>{this.toPath('/wode/info/nicheng')}}>
                ...
                <div className="grxx_box a_click" onClick={()=>{this.toPath('/wode/info/geqian')}}>
                ...
                <div className="grxx_box a_click" onClick={()=>{this.toPath('/wode/info/shengri')}}>
                ...
                <div className="grxx_box a_click" onClick={()=>{this.toPath('/wode/info/zhanghao')}}>
